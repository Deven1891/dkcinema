...
export const MOVIE_DETAILS_REQUEST = "MOVIES_DETAILS_REQUEST";
export const MOVIE_DETAILS_SUCCESS = "MOVIES_DETAILS_SUCCESS";
export const MOVIE_DETAILS_FAIL    = "MOVIES_DETAILS_FAIL";
export const MOVIE_DETAILS_RESET   = "MOVIES_DETAILS_RESET";
